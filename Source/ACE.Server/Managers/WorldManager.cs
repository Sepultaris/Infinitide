    ...
    public static class WorldManager
    {
        ...
        private static void DoPlayerEnterWorld(ISession session, Character character, Biota playerBiota, PossessedBiotas possessedBiotas)
        {
            ...
            if (playerBiota.WeenieType == WeenieType.Admin)
                ...
                player = new InfinitidePlayer(playerBiota, possessedBiotas.Inventory, possessedBiotas.WieldedItems, character, session);
        ...
        /// </summary>
        public static void ThreadSafeTeleport(InfinitidePlayer player, InstancedPosition newPosition, bool teleportingFromInstance, IAction actionToFollowUpWith = null, bool fromPortal = false)
        {
