...
namespace ACE.Server.WorldObjects
{
    partial class Creature
    {
        ...
        public bool CreatureStatsUpdated
        {
            get => GetProperty(PropertyBool.CreatureStatsUpdated) ?? false;
            set { if (!value) RemoveProperty(PropertyBool.CreatureStatsUpdated); else SetProperty(PropertyBool.CreatureStatsUpdated, value); }
        }
    }
}
