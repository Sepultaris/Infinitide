...
namespace ACE.Server.WorldObjects
{
    partial class Player
    {
        ...
        {
            get => GetProperty(PropertyInt.RaisedQuick) ?? 0;
        ...
        {
            get => GetProperty(PropertyInt.RaisedFocus) ?? 0;
        ...
        {
            get => GetProperty(PropertyInt.RaisedSelf) ?? 0;
