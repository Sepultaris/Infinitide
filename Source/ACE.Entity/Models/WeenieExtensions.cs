...
namespace ACE.Entity.Models
{
    public static class WeenieExtensions
    {
        ...
        public static uint? GetPropertyAttribute2nd(this Weenie weenie, PropertyAttribute2nd property)
        {
            if (weenie.PropertiesAttribute2nd == null)
                return null;

            if (weenie.PropertiesAttribute2nd.TryGetValue(property, out var value))
