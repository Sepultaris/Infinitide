...
namespace ACE.Entity.Enum.Properties
{
    public enum PropertyBool : ushort
    {
        ...
        /// <summary>
        /// Set this to true for base weenies that will serve as a base for auto-populated vendor objects,
        /// to prevent the object from disappearing. 
        /// This is not needed for weenies that are a vendor service.
        /// </summary>
        [ServerOnly]
        VendorAutoGenerated              = 42001,
